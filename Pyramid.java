...
public class Pyramid
{
  ...
  public static String writeGcode(HashMap<String, String> settings) throws IOException {
    ...
    Pyramid.Material curr = new Pyramid.Material();
  ...
  private static void printOuter(Pyramid.Material mat, int i)
    throws IOException
  {
    ArrayList<Double> x = new ArrayList();
    ArrayList<Double> y = new ArrayList();
  ...
  static class Material {
    ...
    public static void initialDump(Material mat, double load_depth, double initial_dump_speed, double[] dump) throws IOException
    {
      ...
      Pyramid.out.write(String.format("G01 F%4.2f E%4.2f\n", new Object[] { Double.valueOf(initial_dump_speed), Double.valueOf(load_depth - Pyramid.retract_after_dump) }));
